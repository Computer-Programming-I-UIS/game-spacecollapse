void createButtoms()
{
  ...
  Pause = new Buttom(width/2-150, height/3+200, 300, 50, 10, #00ffff, 0, 9, #808080, 0, (133), "MAIN MENU", 255, 0, 50, 0, 40, 35, (0), 1920/2+100, 1080/2+100, 0, 0.1);
  Continue = new Buttom(width/2-150, height/3+100, 300, 50, 10, #00ffff, 0, 9, #808080, 0, (133), "CONTINUE", 0, 255, 100, 0, 40, 45, (3), 1920/2+100, 1080/2+100, 0, 0.1);
  
  tutorial = new Buttom(width/2-150, height/3+100, 300, 50, 10, #00ffff, 0, 9, #808080, 0, (133), "TUTORIAL", 200, 255, 0, 0, 40, 60, (5), 1920/2+100, 1080/2+100, 0, 0.1);
  credits = new Buttom(width/2-150, height/3+200, 300, 50, 10, #00ffff, 0, 9, #808080, 0, (133), "CREDITS", 255, 255, 0, 0, 40, 70, (2), 1920/2+100, 1080/2+100, 0, 0.1);

void createButtoms()
{
  ...
  start = new Buttom(width/2-150, height/3, 300, 70, 12, #00ffff, 0, 10, #808080, 0, (133), "START", width/2, height/2.5, 0, 255, 255, 0, 50, (4), 1920/2-50, 1080/2, 0, 0);
  config = new Buttom(width/2-150, height/2, 300, 70, 12, #00ffff, 0, 10, #808080, 0, (133), "CREDITS", width/2, height/1.77, 255, 255, 0, 0, 50, (2), 1920/2, 0, 0, 0.1);
